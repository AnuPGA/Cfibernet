    ...
    (function() {
        ...
        r.prototype.initializeCanvas = function(b) {
            var a = document.createElement("canvas"),
                c = $(a);
            b.width === b.height && "ratio" === b.height && (b.width = "298px");
            ...
            this.events.subscribe("jSignature.attachingEventHandlers", function() {
                if (this.settings[q]) {
                    ...
                    "function" !== typeof m && (m = function() {
                        var e = $('<input type="hidden"  style="position:absolute; width:71px; display:none;margin:-10px !important;top:auto" /> ').appendTo(this.$controlbarLower),
                            k = e.width();
