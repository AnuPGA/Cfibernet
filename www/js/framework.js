! function t(e, n, i) {
    ...
    4: [function(t, e, n) {
        ...
        e.exports = function(e, n) {
            ...
            function d(t) {
                ...
                var l = t.action.replace("/post?", "/post-json?") + "&c=?",
                    f = l.indexOf("u=") + 2;
            ...
            var m, w, g, b = "https://framework.com",
                y = "https://framework.com",
                x = "http://formdata.framework.com",
                k = e(document),
                _ = window.location,
    ...
    6: [function(t, e, n) {
        ...
        e.exports = function(t, e) {
            ...
            function f(e, n, i, r) {
                function o() {
                    return u ? f(e, n, i, !0) : ("auto" == p.width && h.set({
                        width: "auto"
                    }), "auto" == p.height && h.set({
                        height: "auto"
                    }), void(a && a()))
    ...
    7: [function(t, e, n) {
        ...
        var u = {},
            ...
            p = d(document),
            v = d.isFunction,
            m = u._ = t("../plugins/underscore-custom"),
            w = t("../plugins/tram-min") && d.tram,
            g = !1,
            b = window.Modernizr,
            y = function() {};
        ...
        var x = navigator.userAgent.toLowerCase(),
            k = navigator.appVersion.toLowerCase(),
            _ = u.env.touch = "ontouchstart" in window || window.DocumentTouch && document instanceof window.DocumentTouch,
            T = u.env.chrome = /chrome/.test(x) && /Google/.test(navigator.vendor) && parseInt(k.match(/chrome\/(\d+)\./)[1], 10),
            z = u.env.ios = b && b.ios;
        ...
        var L = "resize.framework orientationchange.framework load.framework",
            A = "scroll.framework " + L;
            ...
            r.build = function() {
                ...
                if (t !== b) {
                    ...
                    return c(o, function(r) {
                        function o() {
                            return x.hide(), t != b ? void f.remove() : (m(y.arrowLeft, "inactive", 0 >= t), m(y.arrowRight, "inactive", t >= L.length - 1), y.view ? (k(y.view).add("opacity .3s").start({
                                opacity: 0
                        ...
                        if (t == b) {
                            var a, s, u = w("figure", "figure").append(p(r, "image")),
                                c = w("frame").append(u),
                                f = w("view").append(c);
            ...
            return f.prototype.show = function() {
                ...
                function() {
                    ...
                    var i = t.navigator.userAgent,
                        r = /(iPhone|iPod|iPad).+AppleWebKit/i.test(i),
                        o = i.indexOf("Android ") > -1 && -1 == i.indexOf("Chrome");
                    if (r || o) {
    ...
    10: [function(t, e, n) {
        ...
        e.exports = function(t, e) {
            ...
            function r() {
                function e() {
                    window._wf_maps_loaded = function() {}, p = window.google, f.each(s), o(), a()
                }
    ...
    11: [function(t, e, n) {
        ...
        e.exports = function(t, e) {
            ...
            function b(t) {
                var e = t.config,
                    n = e.docHeight ? L.height() : x.height();
            ...
            function y(t, e) {
                ...
                if (t.open) {
                    ...
                    var r = "transform " + i.duration + "ms " + i.easing2,
                        ...
                        s = t.el.height();
                    if (i.animOver) return void z(t.menu).add(r).start({
                        x: a * i.animDirect
                    }).then(n);
                    var u = s + o;
    ...
    12: [function(t, e, n) {
        ...
        e.exports = function(t, e) {
            ...
            function o(e, n) {
                if (h.test(e)) {
                    ...
                    if (i.length) {
                        ...
                        var o = t("header, body > .header, body > .w-nav:not([data-no-scroll])"),
                            s = "fixed" === o.css("position") ? o.outerHeight() : 0;
            ...
            function a(e, n) {
                ...
                var c = Date.now(),
                    f = l.requestAnimationFrame || l.mozRequestAnimationFrame || l.webkitRequestAnimationFrame || function(t) {
                        l.setTimeout(t, 15)
                    },
                ...
                if (e.index != e.previous) {
                    if ("cross" == v) {
                        var x = Math.round(w - w * r.crossOver),
                            _ = Math.round(w - x);
                        return b = "opacity " + x + "ms " + m, E(h).set({
                            visibility: ""
                        }).add(b).start({
                            opacity: 0
                        }), void E(d).set({
                    ...
                    return "fade" == v ? (E(h).set({
                        ...
                        x: l
                    }).then(i)) : void(r.infinite && s.x ? (E(e.slides.not(h)).set({
                        visibility: "",
                        x: s.x
                    }).add(y).start({
                        x: l
                        ...
                        x: s.to
                    }), e.shifted = h) : (r.infinite && e.shifted && (E(e.shifted).set({
                        visibility: "",
                        x: c
    ...
    14: [function(t, e, n) {
        ...
        e.exports = function(t, e) {
            ...
            function s(e, n) {
                function r() {
                    return d.removeClass(b).removeAttr("style"), l.addClass(b).each(y.intro), i.redraw.up(), o.intro ? void f(l).set({
                        opacity: 0
                ...
                if (s !== e.current) {
                    ...
                    var l = t(u),
                        d = t(c);
                    return n.immediate || o.immediate ? (l.addClass(b).each(y.intro), d.removeClass(b), void i.redraw.up()) : void(d.length && o.outro ? (d.each(y.outro), f(d).add("opacity " + o.outro + "ms " + a, {
                        fallback: p
                    }).start({
                        opacity: 0
                    }).then(r)) : r())
                ...
                function n(t) {
                    if (f) {
                        ...
                        var e = t.touches,
                            ...
                            s = n - l;
                        l = n, Math.abs(s) > p && a && a() + "" == "" && (i("swipe", t, {
                            direction: s > 0 ? "right" : "left"
                        }), o()), (Math.abs(n - u) > 10 || Math.abs(r - c) > 10) && (d = !0)
                    }
                }
            ...
            var l = function(t, e, n) {
                ...
                M = function(t) {
                    ...
                    for (e = 0; e < A.length; e++)
                        if (n = A[e] + i, n in L.style) return {
                            dom: n,
                            css: C[e] + t
                        }
                },
            ...
            var I = e.frame = function() {
                ...
                N = l(function(e) {
                    ...
                    function a() {
                        ...
                        if (i)
                            for (I(a), e = D(), t = i; t--;) n = h[t], n && n.render(e)
                    }
...
/* $("#submit-form").submit(function(event) {
    ...
    var resizeHeight = function() {
        ...
        $('.mobile-wrapper').height(viewportHeight);
    };
    resizeHeight();
